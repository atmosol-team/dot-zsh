# Generated by Powerlevel10k configuration wizard on 2021-08-01 at 01:13 MST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( VCS_STATUS_ACTION )) || (( VCS_STATUS_NUM_STAGED )) || (( VCS_STATUS_NUM_UNSTAGED )) || \
      (( VCS_STATUS_NUM_UNTRACKED )) || (( VCS_STATUS_HAS_UNSTAGED ));
    then
      # Styling for up-to-date but unclean Git status.
      local       meta='%234F'
      local      clean='%234F'
      local   modified='%234F'
      local  untracked='%234F'
      local conflicted='%234F'
    elif (( $1 )); then
      # Styling for up-to-date and clean Git status.
